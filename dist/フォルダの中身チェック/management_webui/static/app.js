...
const i18n = {
  ja: {
    ...
    'dash.cmdHistoryKicker': 'コマンド履歴',
    'dash.commandCenterKicker': '操作パネル',
    ...
    'candidates.desc': '本編の用語辞典に追加するかどうか検討中の、次の候補です。既に昇格済みの用語はここには表示されません。',
  ...
  en: {
    ...
    'candidates.desc': 'Additional terms being evaluated for the main glossary. Promoted terms are already removed from this list.',
...
let enGlossaryData = {
  ...
  "--help / -h": "Shows a quick usage guide. Most commands support this. Check it first.",
  ".gitignore": "A config file telling Git 'don't track these files.' Used to exclude passwords and auto-generated files.",
  "403エラー / Forbidden": "'Access denied.' Login required or you don't have permission.",
  "404エラー / Not Found": "'Page not found.' The URL is wrong or the page was deleted.",
  "500エラー / Internal Server Error": "Something went wrong on the server side. Usually not your fault.",
  "> / >> (リダイレクト)": "Saves command output to a file. > overwrites, >> appends.",
  "alias": "Creates shortcuts for frequently used commands.",
  "API (Web API)": "A doorway for programs to communicate over the internet.",
  "cat": "Displays file contents in the terminal. Good for quick peeks at small files.",
  "cd": "Changes to another directory/folder.",
  "CORSエラー": "Browser blocks cross-origin requests for security.",
  "DNS": "Translates domain names into IP addresses. The internet's phone book.",
  "echo": "Prints specified text to the screen. Commonly used to create config files.",
  "export": "Sets an environment variable.",
  "fetch": "Retrieving information about changes from GitHub without applying them yet. Useful for reviewing before pulling.",
  "find": "Finds files and folders by name.",
  "git diff": "Shows what changed in files as additions/deletions. Check before committing.",
  "git stash": "Temporarily shelves your changes. Useful when you need to switch branches mid-work.",
  "git status": "Shows the current Git state — which files are changed and what's ready to commit.",
  "GPU": "A specialized processor for graphics. Also excellent for AI computation.",
  "grep": "Searches for text patterns inside files. grep 'error' log.txt finds errors in logs.",
  "head / tail": "Shows the first (head) or last (tail) 10 lines of a file.",
  "history": "Shows your command history. Also accessible with up/down arrow keys.",
  "HTTPS / SSL / TLS": "Encrypts web communication. URLs starting with https:// are secure.",
  "IDE (統合開発環境)": "An all-in-one coding tool with editor, debugger, and more. VS Code is popular.",
  "LoRA": "A small add-on that teaches an AI model a new style or concept.",
  "ls": "Lists files and folders in the current directory.",
  "man": "Displays the manual for a command. man ls shows everything ls can do.",
  "mkdir": "Creates a new directory/folder.",
  "origin": "The default name Git gives to your repository's original remote location (GitHub URL).",
  "pull": "Fetching the latest changes from GitHub to your local machine. The opposite of push.",
  "pwd": "Prints the current directory path — shows where you are in the computer.",
  "Rate Limit / レート制限": "'Too many requests in a short time.' Common when overusing APIs.",
  "release": "Packaging and publishing a finished version of software. GitHub Releases hosts zips and installers.",
  "source": "Reads and applies a config file to the current terminal session.",
  "SSH": "A secure way to connect to and control a remote computer.",
  "tag": "Labeling a commit with a version name like 'v1.0.' Marks releases.",
  "touch": "Creates an empty file.",
  "upstream": "The name for the original repo you forked from. origin = your copy, upstream = the original.",
  "VRAM": "The GPU's dedicated memory. More VRAM lets you run larger AI models.",
  "| (パイプ)": "Passes the output of the left command to the right command. ls | grep test filters file list.",
  "イメージ (image)": "A blueprint for containers. Create a container from an image and get an identical environment.",
  "インタプリタ (interpreter)": "Executes code line by line. Python and JavaScript work this way.",
  "エディタ (editor)": "An app for writing code. Examples: VS Code, Cursor, Vim.",
  "エンドポイント (endpoint)": "A specific URL for an API function.",
  "キャッシュ (cache)": "Storing previously loaded data for faster access next time.",
  "クライアント (client)": "The side that receives data from a server. Your browser or phone app is a client.",
  "クラウド (cloud)": "Someone else's computer accessed over the internet.",
  "クラス (class)": "A blueprint for creating objects. You create 'instances' from a class.",
  "コンテナ (container)": "A self-contained package for running apps (created with Docker).",
  "コンパイル (compile)": "Translating human-written code into machine-executable form.",
  "サーバー (server)": "A computer that provides data or services.",
  "セルフホスト (self-host)": "Running software on your own computer or server instead of using cloud services.",
  "チェックポイント (checkpoint)": "A saved snapshot of an AI model during training.",
  "デバッグ (debug)": "Finding and fixing bugs using print statements or special tools.",
  "デプロイ (deploy)": "Putting your program on a server so others can use it.",
  "ドメイン (domain)": "The name part of a web address (like google.com).",
  "バグ (bug)": "An error or flaw in a program that causes incorrect behavior.",
  "パッケージマネージャー": "A tool that installs and manages packages. Examples: pip (Python), npm (Node.js).",
  "フレームワーク": "A structural foundation for building apps. Handles common boilerplate.",
  "プロセス (process)": "A running program. Each line in Task Manager is a process.",
  "プロンプト (prompt)": "The instruction you give to AI. Like 'draw a cute cat' or 'find bugs.'",
  "モデル (AI model)": "The 'brain' file of an AI. Trained on lots of data.",
  "ライブラリ / モジュール": "A collection of useful functions. Import it in Python with 'import'.",
  "ループ (loop)": "Repeating the same process. Use 'for' or 'while' to loop.",
  "変数 (variable)": "A named container for data. Like name = 'Taro'.",
  "学習 / 訓練 (training)": "Making AI smarter by feeding it lots of data. Takes time and computing power.",
  "引数 (argument)": "Values passed to a function. In def greet(name):, name is the parameter.",
  "戻り値 (return value)": "The result a function gives back.",
  "推論 (inference)": "AI using its trained model to produce an answer.",
  "条件分岐 (if)": "Branching logic — 'if this, do A; else do B.' Uses if, elif, else.",
  "関数 (function)": "A reusable block of code. Defined with 'def name():' and called when needed.",
};
...
const jaTerms = {
  ...
  '--help / -h': 'ほとんどの命令で使える、簡単な使い方の説明を表示するオプション。最初に見るべき。',
  '.gitignore': 'Gitに「このファイルは管理しないで」と伝える設定ファイル。パスワードのファイルや、自動生成されるファイルを除外するのに使う。',
  '403エラー / Forbidden': '「アクセス権がありません」というエラー。ログインが必要だったり、そのページを見る許可がない。',
  '404エラー / Not Found': '「そのページは見つかりません」というエラー。URLが間違っているか、ページが削除された可能性が高い。',
  '500エラー / Internal Server Error': 'サーバー側で何かが失敗したというエラー。自分ではなく、アクセス先のサーバーに問題があることが多い。',
  '> / >> (リダイレクト)': '命令の結果をファイルに保存する記号。> は上書き、>> は追記。echo \'hello\' > file.txt でファイルに書き込める。',
  'alias': 'よく使う長い命令に短い名前を付ける機能。alias ll=\'ls -la\' と設定すると、llだけで長い一覧が出る。',
  'API (Web API)': 'プログラム同士がインターネット越しにやり取りする窓口。AIサービスもAPI経由で使うことが多い。',
  'cat': 'ファイルの中身をターミナルに表示する命令。小さなファイルをさっと見るのに便利。',
  'cd': '別のフォルダに移動する命令。cd Documents でDocumentsフォルダに入る。',
  'CORSエラー': 'ブラウザが「別のサイトからのアクセス」を安全のためブロックしたというエラー。フロントエンド開発でよく出る。',
  'DNS': 'ドメイン名（example.com）をIPアドレス（192.0.2.1）に変換する仕組み。インターネットの電話帳。',
  'echo': '指定した文字を画面に表示する命令。設定ファイルを作るときによく使われる。',
  'export': '環境変数を設定する命令。export API_KEY=*** のように使う。',
  'fetch': 'GitHubなどから「変更があったよ」という情報だけを取ってきて、まだ手元のファイルには反映しないこと。pullする前に確認したい時に使う。',
  'find': 'ファイルやフォルダを名前で探す命令。find . -name \'*.py\' でPythonファイルを全部探せる。',
  'git diff': 'ファイルの「どこを変えたか」を、追加・削除の形で表示する命令。コミットする前に確認したい時に使う。',
  'git stash': '今の変更を「一時的に棚上げ」する命令。別のブランチに急に行かなきゃいけなくなった時などに使う。後で戻せる。',
  'git status': '「今Gitがどんな状態か」を表示する命令。どのファイルを変更したか、何がコミット待ちかが分かる。',
  'GPU': '画像処理を専門に行う部品。AIの計算にも非常に適していて、モデルの学習や推論を高速化する。',
  'grep': 'ファイルの中から特定の文字列を検索する命令。grep \'エラー\' log.txt でログから「エラー」を探せる。',
  'head / tail': 'ファイルの最初（head）か最後（tail）の10行だけを表示する命令。長いファイルの確認に便利。',
  'history': '今まで打った命令の履歴を表示する。上下キーでも呼び出せる。',
  'HTTPS / SSL / TLS': 'Webサイトの通信を暗号化する仕組み。URLがhttps://で始まっていると安全。鍵マークが出ているか確認しよう。',
  'IDE (統合開発環境)': 'コードを書くための多機能エディタ。コード補完、実行、デバッグがひとつになったもの。VS Codeが有名。',
  'LoRA': '大きなAIモデルに「この絵柄を覚えて」と追加で教えるための小さなデータ。フルモデルより軽くて増やしやすい。',
  'ls': '今いるフォルダの中に何のファイルやフォルダがあるかを一覧表示する命令。',
  'man': '命令の詳しい説明書（マニュアル）を表示する。man ls でlsの全機能が分かる。',
  'mkdir': '新しいフォルダを作る命令。mkdir プロジェクト名 で空のフォルダができる。',
  'origin': 'Gitで、自分のリポジトリの元の場所（GitHubのURL）につける標準的な名前。',
  'pull': 'GitHubなどから最新の変更を手元に取り込むこと。pushの反対。',
  'pwd': '「今どこにいるか」を表示する命令。パソコンの中の自分の位置が分かる。',
  'Rate Limit / レート制限': '「短時間にアクセスしすぎです」というエラー。APIなどを連続で呼びすぎると制限がかかる。',
  'release': 'ソフトの完成品を配布できる形にまとめて公開すること。GitHubでは「Releases」ページにzipやインストーラを置ける。',
  'source': '設定ファイルを読み込んで、今のターミナルに反映する命令。.bashrcなどを変更した後に使う。',
  'SSH': '遠くのコンピュータに安全に接続して操作する仕組み。暗号化されていて、パスワードや鍵で認証する。',
  'tag': 'Gitのコミットに「v1.0」のようなバージョン名を付けること。リリースの目印になる。',
  'touch': '空のファイルを作る命令。touch README.md でREADME.mdファイルができる。',
  'upstream': 'フォーク元のリポジトリにつける名前。originが自分のコピー、upstreamが元の本家。',
  'VRAM': 'GPUが使う専用のメモリ。大きいほど大きなAIモデルを動かせる。',
  '| (パイプ)': '左の命令の結果を右の命令に渡す記号。ls | grep test で、ファイル一覧から「test」を含むものだけ表示できる。',
  'イメージ (image)': 'コンテナの「設計図」や「型」。イメージからコンテナを作ると、まったく同じ環境が再現できる。',
  'インタプリタ (interpreter)': 'コードを1行ずつ翻訳しながら実行する方式。PythonやJavaScriptがこれ。',
  'エディタ (editor)': 'コードを書くためのアプリ。メモ帳より高機能。VS Code、Cursor、Vimなどがある。',
  'エンドポイント (endpoint)': 'APIの具体的な接続先URL。https://api.example.com/v1/generate のような形。',
  'キャッシュ (cache)': '一度読み込んだデータを覚えておいて、次は速く表示する仕組み。ブラウザやCDNでよく使われる。',
  'クライアント (client)': 'サーバーからデータを受け取る側。普段使っているブラウザやスマホアプリがクライアントにあたる。',
  'クラウド (cloud)': 'インターネット越しに使う、どこかの会社のコンピュータ。自分のパソコンじゃなくて、向こうのパソコンで動かす。',
  'クラス (class)': '設計図のようなもの。クラスをもとに「インスタンス」という実物を作って使う。',
  'コンテナ (container)': 'アプリを実行するための「小さな独立した箱」。Dockerで作る。箱の中にアプリと必要な部品が全部入っていて、どこでも動く。',
  'コンパイル (compile)': '人間が書いたコードを、パソコンが実行できる形に翻訳すること。C言語などはこの工程が必要。',
  'サーバー (server)': 'データを提供する側のコンピュータ。Webサイトを表示するためのデータを送ったり、AIの計算をしたりする。',
  'セルフホスト (self-host)': 'クラウドを使わずに、自分のパソコンや自分で用意したサーバーでアプリを動かすこと。',
  'チェックポイント (checkpoint)': 'AIモデルの「途中保存」データ。学習を途中で止めて保存した状態で、そこから再開できる。',
  'デバッグ (debug)': 'プログラムのバグ（不具合）を見つけて直す作業。print文を仕込んだり、専用の道具を使ったりする。',
  'デプロイ (deploy)': '作ったプログラムを実際に使える状態でサーバーに配置すること。「公開する」の開発者版。',
  'ドメイン (domain)': 'インターネット上の住所の名前部分。example.com や google.com のようなもの。',
  'バグ (bug)': 'プログラムの誤りや不具合。動かなかったり、変な動きをしたりする原因。',
  'パッケージマネージャー': 'ライブラリやツールを自動でインストール・管理する道具。pip（Python）、npm（Node.js）、apt（Linux）など。',
  'フレームワーク': 'アプリの骨組みを提供してくれる大きな部品集。これを使うと、共通の面倒な部分を自分で書かずに済む。',
  'プロセス (process)': '実行中のプログラムのこと。タスクマネージャーで見える一つ一つの行がプロセス。',
  'プロンプト (prompt)': 'AIに渡す指示文。「かわいい猫の画像を作って」「このコードのバグを教えて」のように。',
  'モデル (AI model)': 'AIの頭脳にあたるファイル。たくさんの学習データから作られる。「これに質問すると答えが返ってくる」入れ物。',
  'ライブラリ / モジュール': '便利な機能をまとめた部品集。Pythonではimportで読み込む。自分で全部書かなくて済む。',
  'ループ (loop)': '同じ処理を繰り返す書き方。for i in range(10): で10回繰り返せる。',
  '変数 (variable)': 'データを入れておく名前付きの箱。name = \'Taro\' のように使う。',
  '学習 / 訓練 (training)': 'AIに大量のデータを与えて「賢くする」作業。時間と電力と計算資源がかかる。',
  '引数 (argument)': '関数に渡す値。def greet(name): の name が引数で、greet(\'Taro\') のように使う。',
  '戻り値 (return value)': '関数から返ってくる結果。def add(a, b): return a + b の場合、add(1,2) は3を返す。',
  '推論 (inference)': 'AIが学習済みモデルを使って実際に答えを出すこと。画像を生成するときや、質問に答えるときの動作。',
  '条件分岐 (if)': '「もし〜ならA、違うならB」と処理を分ける書き方。if, elif, else で書く。',
  '関数 (function)': 'よく使う処理をひとまとめにしたブロック。def 名前(): で定義して、必要なときに呼び出せる。',
};
